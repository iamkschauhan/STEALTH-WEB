...
export const LoginView: React.FC<LoginViewProps> = ({
  ...
  const validateUsername = (value: string): boolean => {
    ...
    return emailRegex.test(value) || phoneRegex.test(value) || value.trim().length >= 3;
  };
    ...
    <div className="min-h-screen bg-dark-bg flex items-center justify-center py-10">
      <div className="w-full max-w-content md:max-w-lg lg:max-w-xl mx-auto px-screen-padding md:px-8">
        ...
        <div className="flex gap-4 mb-6">
          <Button variant="icon" onClick={handleAppleLogin} disabled={isSubmitting}>
          ...
          <Button variant="icon" onClick={handleGoogleLogin} disabled={isSubmitting}>
        ...
        <button
          ...
          className="text-link-action font-semibold text-orange mb-4 block w-full"
        >
          Forgot Password?
        </button>
